...
namespace CommerceApp.Infrastructure.Tokens
{
    public class TokenService : ITokenService
    {
        ...
        public async Task<JwtSecurityToken> CreateToken(User user, List<string> roles)
        {
        ...
        private IList<Claim> GetClaims(User user, List<string> roles)
        {
